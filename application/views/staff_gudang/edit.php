									...
									<form action="<?= base_url('staff_gudang/proses_edit/' . $staff_gudang->id) ?>"
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label for="kode">ID Staff Gudang</label>
												<input type="text" name="kode" placeholder="Masukkan Kode staff_gudang"
													autocomplete="off" class="form-control" required
													value="<?= $staff_gudang->kode ?>" maxlength="8" readonly>
											</div>
											<div class="form-group col-md-6">
												<label for="nama">Nama Staff Gudang</label>
												<input type="text" name="nama" placeholder="Masukkan Nama staff_gudang"
													autocomplete="off" class="form-control" required
													value="<?= $staff_gudang->nama ?>">
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-6">
