									...
									<form action="<?= base_url('usaha/proses_edit') ?>" id="form-tambah" method="POST">
										...
										<div class="form-group">
											...
											<textarea readonly name="alamat" id="alamat" class="form-control"
												...
												style="resize: none;"><?= $usaha->alamat ?></textarea>
										</div>
										<hr>
										<div class="form-group">
