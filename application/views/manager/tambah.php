				...
				<div class="container-fluid">
					<div class="clearfix">
						...
						<div class="float-right">
							<a href="<?= base_url('manager') ?>" class="btn btn-secondary btn-sm"><i
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card shadow">
								...
								<div class="card-body">
									<form action="<?= base_url('manager/proses_tambah') ?>" id="form-tambah"
										method="POST">
										<a>
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label for="kode">Kode Manager</label>
												<input type="text" name="kode" placeholder="Masukkan Kode Manager"
													autocomplete="off" class="form-control" required
													value="MNG<?= mt_rand(1, 1000) ?>" maxlength="8" readonly>
											</div>
											<div class="form-group col-md-6">
												<label for="nama">Nama Manager</label>
												<input type="text" name="nama" placeholder="Masukkan Nama Manager"
													autocomplete="off" class="form-control" required>
											</div>
										</div>
										<div class="form-row">
